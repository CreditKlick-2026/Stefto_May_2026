...
const menuData = {
  ...
  industries: {
    ...
    items: [
      { name: "Healthcare", description: "Patient helpdesk & appointment mgmt", icon: Heart, href: "/services", color: "bg-red-50 text-red-600" },
      { name: "Automotive", description: "Dealer & aftersales support", icon: Building2, href: "/services", color: "bg-cyan-50 text-cyan-600" },
      { name: "Technology", description: "Technical support & helpdesk", icon: Settings, href: "/services", color: "bg-blue-50 text-blue-600" },
      { name: "Travel & Hospitality", description: "Booking support & customer care", icon: Globe, href: "/services", color: "bg-purple-50 text-purple-600" },
    ]
  },
  company: {
    title: "Company",
  ...
  aboutUs: {
    title: "About Us",
    items: [
      { name: "Company", description: "Our mission, vision & values", icon: Users, href: "/about-us", color: "bg-blue-50 text-blue-600" },
