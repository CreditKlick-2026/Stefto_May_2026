      ...
      <section className="w-full pt-4 pb-16 sm:pt-6 sm:pb-24 bg-white">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-[900px]">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-800 mb-6 lg:mb-10" style={{ fontFamily: "'Fraunces', serif" }}>
          ...
          <div className="relative flex flex-col lg:flex-row">
            ...
            <div className="w-full lg:w-[45%] h-[400px] sm:h-[600px] relative">
              ...
              <div className="absolute top-6 sm:top-10 left-[50%] lg:left-[65%] z-30 whitespace-nowrap">
                <h2 className="text-[1rem] sm:text-xl lg:text-[22px] tracking-[0.25em] sm:tracking-[0.3em] text-black uppercase font-medium" style={{ fontFamily: "'Fraunces', serif" }}>
